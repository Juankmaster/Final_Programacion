...
<body>
				...
				<!--panel para la tabla de procesos  -->

				  <div class="panel-body" >
				  	<div class="row">

	<!-- lista para seleccionar la empresa a la que se le asignara los procesos  -->
		...
		<!-- Tabla donde se muestran los procesos registrados para cada empresa-->
