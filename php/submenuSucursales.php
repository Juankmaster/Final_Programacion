...
<body>
				...
				<!--panel para la tabla de proveedores  -->

				  <div class="panel-body" >
				  	<div class="row">

	<!-- lista para seleccionar la empresa a la que se le asignara las Sucursales-->
		...
		<!-- Tabla donde se muestran las Sucursales registrados para cada empresa-->
