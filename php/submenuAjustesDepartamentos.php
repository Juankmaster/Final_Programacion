...
<!-- Tablas para mostrar los Departamentos que existen -->
 <div class="panel panel-default">
   <div class="panel-heading" style="background:#0971B3"><span style="color:#000;">DEPARTAMENTOS</span></div>
...
<!-- Panel donde se mostrara el  formulario para editar los Departamentos -->
	<div class="col-sm-8">
		<div id="editar">	
