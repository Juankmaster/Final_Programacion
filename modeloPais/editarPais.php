...
include '../modeloPais/modelo_pais.php';
		    ...
		    $pais=new Pais();
	        $resultado= $pais->consultar($id_pais);	
	...
	<div class="panel-group">
	  <div class="panel panel-primary" >
	  	<div class="panel-heading" style="background:#0971B3">
		   <span style="color:#000;">EDITANDO PAIS</span>
		</div>

		<div class="panel-body">
		  <div class="form-group">
		   <label  for="id_ciudad" class="control-label col-sm-2">ID:</label>
		   <div class="col-sm-10">
		   <input type="text" class="form-control required" readonly="true"
		          value="<?php echo trim($resultado[0]['id_pais']);?>" name="id_pais" >
		   </div>
		</div>
		...
		<div class="form-group">
	       ...
	       <input type="text"class="form-control required" minlength="3"
	            value="<?php echo trim($resultado[0]['Nom_pais']);?>" name="nom_pais">
	      </div>
		</div>
