	...
	<div class="panel-group">
		...
		<div class="form-group">
		 <label  for="id_departamento" class="control-label col-sm-2">ID:</label>
		  <div class="col-sm-10">
		  <input type="text" class="control-label col-sm-2" readonly="true"  name="id_departamento">
		  </div>
		</div>
		...
		<div class="form-group">
		 <label  for="nom_departamento" class="control-label col-sm-2">Nombre:</label>
		  <div class="col-sm-10">
	   <input type="text"  class="form-control" value="" name="nom_departamento" required placeholder="Nombre Departamento">
	  </div>
		</div>
